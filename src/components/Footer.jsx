...
/* ─── PALETTE ─────────────────────────────────────────────────
   Warm Linen    #F5EEE4   footer top band background
   Cream         #EDE5D8   footer body background
   Deep Taupe    #3D2B1F   rich, warm dark text (NOT pitch black)
   Warm Taupe    #7A6556   muted secondary text
   Gold          #B8925A   primary accent
   Gold Warm     #C9A46A   hover gold
   Soft Gold     #E8D5BE   borders / dividers
   Sage          #6B7C5E   telehealth accent
──────────────────────────────────────────────────────────────*/
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-10 pt-16 pb-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div>
              ...
              {/* Mini review badge */}
              <div className="border border-[#E8D5BE] bg-[#FDFAF6]/70 p-4 space-y-2">
                <div className="flex gap-0.5">
                  {Array(5).fill(0).map((_, i) => <StarIcon key={i} />)}
                </div>
                <p className="text-xs text-[#7A6556] leading-relaxed italic">
                  "Dr. Gill truly listens — I felt heard from the very first visit."
                </p>
                <p className="text-[10px] tracking-wider uppercase text-[#B8925A]">Google Review · 5 Stars</p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-5">
                <ContactRow icon={<LocationIcon />} label="Location">
                  <a
                    href="https://maps.google.com/?q=680+Mowry+Ave+Fremont+CA+94536"
                    target="_blank"
          ...
          <div className="mt-7 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#7A6556]/60">
            ...
            <p className="text-[#7A6556]/40">
              Designed by{" "}
              <a href="https://digitalvisibilityconcepts.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#B8925A]/60 transition-colors">
...
function SectionHeading({ children }) {
  return (
    <h3
      className="text-[11px] tracking-[0.2em] uppercase font-semibold text-[#3D2B1F] mb-5 pb-3 border-b border-[#E8D5BE] relative"
...
function CheckIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#B8925A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function StarIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="#B8925A" stroke="none">
